...
let content = (textID[t].id as unknown as TextElement[];


content[].text = "0.0.0.0.0.0.0.0.0"// enter text ar data here MiW!MiW!MiW!M
...
let prevWidth = char[0].getBBox().width;
