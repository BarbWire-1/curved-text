...
const construct = el => {
  ...
  // No, I think we should only need the <use>´s ID
  // But there is some structural crossing at the moment, I think
  ...
  // or we could only have rotating settings ant font-style would have to be set manually in css or svg
  ...
  el.redraw = () => {
    ...
    for (i = 0; i < numChars ; i++) {
        ...
        if (modus == "auto") {
          ...
          console.log("width textE"+ textWidth2 )
